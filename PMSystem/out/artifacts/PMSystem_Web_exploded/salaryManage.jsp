...
<input type="hidden" id="gradePageCount"value="${gradePageCount}">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">员工薪水管理</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">员工薪水管理</h1>
			</div>
		</div><!--/.row-->
		...
		<div>
			<div>
				<div class="col-xs-12 ">
					<form action="${pageContext.request.contextPath}/SalaryManageServlet?op=find&currentPageIndex=1" id="findform" method="post">
						<div class="row">
							<div class="col-sm-5">
								<div>
        ...
        <td width="60%">
            <a href="${pageContext.request.contextPath }/SalaryManageServlet?op=page&currentPageIndex=${pageAll.currentPageIndex -1}" style="text-decoration:none;">|&lt;</a>
            <c:forEach begin="${startIndex}" end="${endIndex }" var="n">
                <a href="${pageContext.request.contextPath }/SalaryManageServlet?op=page&currentPageIndex=${n}">${pageAll.currentPageIndex == n ?"<font color=red>":"<font>"}${n }</font></a>
            </c:forEach>
            <a href="${pageContext.request.contextPath }/SalaryManageServlet?op=page&currentPageIndex=${pageAll.currentPageIndex +1}" style="text-decoration:none;">&gt;|</a>
        </td>
        <td width="10%">
	...
	<script src="datetimepicker/js/jquery-ui-1.9.2.core.min.js"></script>
	<script src="datetimepicker/js/jquery-ui-1.9.2.datatimeSlider.min.js"></script>
	<script src="datetimepicker/js/jquery-ui-timepicker-addon.js"></script>
	<script src="datetimepicker/js/jquery-ui-timepicker-zh-CN.js"></script>
	<script src="datetimepicker/js/jquery.ui.datepicker-zh-CN.js"></script>
	<script type="text/javascript">
  
    function selectJump(index){
    	window.location.href="${pageContext.request.contextPath }/GradeManageServlet?op=page&currentPageIndex="+index+"&currentPageIndex=${pageAll.currentPageIndex}";
    }
