...
public class ModInfoServlet extends HttpServlet {
	...
	private void addStaff(HttpServletRequest request, HttpServletResponse response) 
		...
		//System.out.println(n+":"+sta);
		 ...
		 response.sendRedirect(request.getContextPath()+"/ModInfoServlet?op=page&currentPageIndex=1");
	}
		...
		ConvertUtils.register(new Converter()
			       {  
			           ...
			           public Object convert(Class arg0, Object arg1)  
			           {
			               ...
			               if(!(arg1 instanceof String))  
			               {  
			                   throw new ConversionException("ֻ只支持字符串转换");
			               }  
	...
	private void deleteMoreStaff(HttpServletRequest request, HttpServletResponse response) 
			throws ServletException, IOException{
